...
Below table shows the definition of the element added to the extension `puf:PageroExtension/puf:ExternalDeliveryType`. This extension is placed in the document-level `ext:UBLExtensions` on the `ApplicationResponse` root element.
